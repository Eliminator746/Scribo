...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "post" | "comment" | "postView"
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"user_id" | "username" | "email" | "password" | "role" | "created_at", ExtArgs["result"]["user"]>
  ...
  export type PostOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"post_id" | "user_id" | "title" | "slug" | "image_url" | "status" | "created_at" | "updated_at", ExtArgs["result"]["post"]>
  ...
  export type CommentOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"comment_id" | "post_id" | "user_id" | "parent_comment_id" | "comment_text" | "status" | "created_at", ExtArgs["result"]["comment"]>
  ...
  export type PostViewOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"post_view_id" | "post_id" | "view_count" | "like_count", ExtArgs["result"]["postView"]>
  ...
  export interface PostViewDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `post_view_id`
     * const postViewWithPost_view_idOnly = await prisma.postView.findMany({ select: { post_view_id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many PostViews and only return the `post_view_id`
     * const postViewWithPost_view_idOnly = await prisma.postView.createManyAndReturn({
     *   select: { post_view_id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * })
     * 
     * // Update zero or more PostViews and only return the `post_view_id`
     * const postViewWithPost_view_idOnly = await prisma.postView.updateManyAndReturn({
     *   select: { post_view_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface PostViewFieldRefs {
    readonly post_view_id: FieldRef<"PostView", 'Int'>
    readonly post_id: FieldRef<"PostView", 'Int'>
    readonly view_count: FieldRef<"PostView", 'Int'>
    readonly like_count: FieldRef<"PostView", 'Int'>
  }
  ...
  export type PostWhereInput = {
    ...
    user_id?: IntNullableFilter<"Post"> | number | null
  ...
  export type PostScalarWhereWithAggregatesInput = {
    ...
    user_id?: IntNullableWithAggregatesFilter<"Post"> | number | null
  ...
  export type PostViewWhereInput = {
    ...
    post_view_id?: IntFilter<"PostView"> | number
    post_id?: IntFilter<"PostView"> | number
    view_count?: IntFilter<"PostView"> | number
    like_count?: IntFilter<"PostView"> | number
    post?: XOR<PostScalarRelationFilter, PostWhereInput>
  }

  export type PostViewOrderByWithRelationInput = {
    post_view_id?: SortOrder
    post_id?: SortOrder
  ...
  export type PostViewScalarWhereWithAggregatesInput = {
    ...
    post_view_id?: IntWithAggregatesFilter<"PostView"> | number
    post_id?: IntWithAggregatesFilter<"PostView"> | number
    view_count?: IntWithAggregatesFilter<"PostView"> | number
    like_count?: IntWithAggregatesFilter<"PostView"> | number
  }
  ...
  export type PostViewUncheckedUpdateInput = {
    post_view_id?: IntFieldUpdateOperationsInput | number
    post_id?: IntFieldUpdateOperationsInput | number
    view_count?: IntFieldUpdateOperationsInput | number
    like_count?: IntFieldUpdateOperationsInput | number
  }
